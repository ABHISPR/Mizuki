...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="#⃣ Source Code", url="https://github.com/ABHISPR/Mizuki"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add me to your group ➕", url="t.me/ABHIxMANAGEMENT_BOT?startgroup=true"
        ),
    ],
]

HELP_STRINGS = """
Hey there! My name is *ABHI BOT*.
